...
parser.add_argument('--exp_name',default="ffhq_clean_mspe",help="Experiment name. Images will be saved in inverse/exp_name and specified checkpoint should be in checkpoints/exp_name")
